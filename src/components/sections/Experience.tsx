            ...
            <div className="lg:sticky lg:top-28">
              ...
              <Reveal delay={0.08}>
                <div className="glass-card mt-10 rounded-2xl p-6">
                  ...
                  <p className="mt-3 text-[15px] font-medium text-ink">{education.degree}</p>
              ...
              <Reveal key={entry.company} delay={0.04 * i}>
                <article className="glass-card mb-5 rounded-2xl p-6 md:p-8 last:mb-0">
                  <div className="flex flex-wrap items-baseline justify-between gap-2">
                    ...
                    {entry.location ? <p className="text-[13px] font-medium text-muted">{entry.location}</p> : null}
                  </div>
                  ...
                  <ul className="mt-6 flex flex-wrap gap-2" aria-label={`Tools used at ${entry.company}`}>
